...
public class BaseBoard implements Paintable {
	...
	private static final String NAME = "base board";
	private double size = 0;
	private boolean isPaintable;
	private double width, trimSize;
	
	
	public BaseBoard(double width, double trimSize) {
		this.width = width;
	...
	public BaseBoard(JSONObject json) throws JSONException {

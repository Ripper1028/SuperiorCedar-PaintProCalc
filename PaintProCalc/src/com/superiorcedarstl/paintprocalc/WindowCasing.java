...
public class WindowCasing implements Paintable {
	...
	public WindowCasing(double width, double height, double depth) {
		this.width = width;
		this.height = height;
		this.depth = depth;
		this.size = ((width + height) * 2) * depth;
		isPaintable = true;
	}
	
	public WindowCasing(JSONObject json) throws JSONException {
